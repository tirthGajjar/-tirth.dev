          ...
          <div className="relative rounded-2xl px-6 py-10 bg-green-400 overflow-hidden shadow-xl sm:px-12 sm:py-20">
            ...
            <div className="relative">
              <div className="sm:text-center">
                <h2 className="text-3xl font-bold text-white dark:text-black tracking-tight sm:text-4xl">
                  Become a better full-stack developer.
                </h2>
                <p className="mt-6 mx-auto max-w-2xl text-lg font-semibold dark:text-gray-600 text-gray-200">
