const TechnicalDetail = () => {
  return (
    <div>
      ...
      <p>
        RAx is technically a complex product. It has many moving components and
        plugins, We primarily use the below mentioned technologies.
      </p>
      <h3>Frontend</h3>
      <ol>
        <li>
          ...
          <ul>
            <li>
              This is our primary frontend framework(VueJS), for a newer version
              we might want to move away from this entirely.
            </li>
          </ul>
        </li>
        <li>
        ...
        <li>
          ...
          <ul>
            <li>
              TailwindUI is the commercial version of the components created by
              the TailwindCSS team.
            </li>
          </ul>
        </li>
      </ol>
      ...
      <ol>
        ...
        <li>
          ...
          <ul>
            <li>
              The landing page is being served using a cloudfront distribution,
              also some User files are also served using cloudfront
            </li>
          </ul>
        </li>
        <li>
      ...
      <ol>
        <li>
          ...
          <ul>
            <li>
              This is our primary database instance, all of the application data
              is stored here.
            </li>
          </ul>
        </li>
