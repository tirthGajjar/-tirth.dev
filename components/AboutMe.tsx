const AboutMe = () => {
  return (
    <div className="py-16 xl:py-36 overflow-hidden prose dark:prose-light md:prose-lg max-w-7xl">
      <div className="max-w-max lg:max-w-7xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="relative md:bg-white md:bg-opacity-90 dark:text-indigo-50 md:dark:bg-gray-900 md:dark:bg-opacity-95 md:p-6">
